...
class InfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create info" do
    assert_difference("Info.count") do
      post infos_url, params: { info: { description: @info.description, name: @info.name, picture: @info.picture } }
    end
  ...
  test "should update info" do
    patch info_url(@info), params: { info: { description: @info.description, name: @info.name, picture: @info.picture } }
